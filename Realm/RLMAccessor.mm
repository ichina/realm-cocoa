...
id RLMAccessorContext::value(__unsafe_unretained id const obj, size_t propIndex) {
...
id RLMAccessorContext::doGetValue(__unsafe_unretained id const obj, size_t propIndex,
                                  __unsafe_unretained RLMProperty *const prop) {
...
RLMOptionalId RLMAccessorContext::value_for_property(__unsafe_unretained id const dict,
                                                     std::string const&, size_t prop_index) {
    return RLMOptionalId{value(dict, prop_index)};
}

RLMOptionalId RLMAccessorContext::default_value_for_property(realm::Realm*,
